        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto links-margin">
                <li class="nav-item link-margin">
                    <a class="nav-link js-scroll-trigger link-hover" href="index.php">Strona główna</a>
                </li>
                <li class="nav-item link-margin">
                    <a class="nav-link js-scroll-trigger link-hover" href="expenses.php">Zarządzanie wydatkami</a>
                </li>
                <li class="nav-item link-margin">
                    <a class="nav-link js-scroll-trigger link-hover" href="categories.php">Zarządzanie kategoriami</a>
                </li>
